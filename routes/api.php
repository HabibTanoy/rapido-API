...
Route::get('/task-list', 'App\Http\Controllers\StatusUpdateAPIController@productList');
Route::get('/task-list-created', 'App\Http\Controllers\StatusUpdateAPIController@productListCreated')->name('task-list');
